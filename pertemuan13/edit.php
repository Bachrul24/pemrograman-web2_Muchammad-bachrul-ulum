...
<body>
	...
	<h1>Form Edit Data</h1>
		...
		<form action="prosesedit.php" method="POST">
			...
			<p>
				<b>Penulis :</b><br>
				<input type="text" name="author" value="<?= $row['penulis'];?>" />
			</p>
			<p>
				<b>Lead :</b><br>
				<textarea name="abstraksi" rows="4" cols="30"> <?= $row['lead'];?></textarea>
			</p>
			<p>
				<b>Content :</b><br>
				<textarea name="konten" rows="8" cols="45"><?= $row['content'];?></textarea>
			</p>
